        ...
        <Container>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.mainHeading}>
              Best IT Solutions & Business Services for Your Company
            </h1>

            {/* Description */}
            <p className={styles.description}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor magna
          ...
          <div className={styles.heroIllustration}>
            {/* This will contain the isometric illustration from the image */}
            <div className={styles.illustrationPlaceholder}>
              <div className={styles.device}>
                ...
                <div className={styles.browser}>
                  <div className={styles.browserHeader}></div>
